...
;; 5. 初次启动时, 执行 (start) 函数
;; 务必注意文本处理，一行文字超过20个字时一定要换行。
;; 只需要输出 svg 代码，不要任何解释，也不需要用代码块包裹。从这个开头 <svg xmlns="http://www.w3.org/2000/svg">
"""
...
;; 2. 主函数为 (翻译 用户输入) 函数
;; 务必注意文本处理，一行文字超过20个字时一定要换行。
;; 只需要输出 svg 代码，不要任何解释，也不需要用代码块包裹。从这个开头 <svg width="450" height="800" xmlns="http://www.w3.org/2000/svg">
"""
